...
{% include figure.liquid
   ...
   class="img-fluid rounded z-depth-1 figure-lines" width="500px"
   %}
...
{% include figure.liquid loading="eager" path="/assets/post-attachments/2026-01-27/five_different_states.png" class="img-fluid rounded z-depth-1" width="500px" %}
...
{% include figure.liquid loading="eager" path="/assets/post-attachments/2026-01-27/start_process.png" class="img-fluid rounded z-depth-1" width="500px" %}
